...
struct Problem {
  ...
  /* Fills the given list with actions enabled in the given state. */
  void enabled_actions_noValues(ActionSet& remainingActions, ActionList&
                                actions, const AtomSet& atoms) const;
...
/* Constructs an action from predicate and term names (predicate and terms must all exist). */
