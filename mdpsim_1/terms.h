...
struct Term {
  ...
  /* Converts this term to an object. As above, fails if the term is not an
     object. */
  Object as_object() const;

  int index() const {return (long)index_;}
 ...
 * An object.
 */
struct Object : public Term {
  /* Constructs an object. */
  explicit Object(int index) : Term(index) {}
...
struct Variable : public Term {
  ...
  explicit Variable(int index) : Term(index) {}
...
/* Converts this object to a term. */
inline Object::operator Term() const { return (Term)*this; }

/* Converts this variable to a term. */
inline Variable::operator Term() const { return (Term)*this; }
...
struct TermTable {
  ...
  /* Gives original name associated with an object */
  static const std::string &object_name(const Object &object);
